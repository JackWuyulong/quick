					...
					<div class="login_box_login pull-left">
						...
						<div class="cent">
							...
							<div class="user">
								...
								<input type="text" id="username" class="pull-right put" maxlength="11" placeholder="请输入手机号"/>
							</div>
							<!--密码-->
							<div class="pwd">
								<span class="pwd_img pull-left"><img src="__ROOT__/Index/Common/img/login/pwd.png" alt="" /></span>
								<input type="password" id="pwd" class="pull-right put" maxlength="11" placeholder="请输入密码"/>
							</div>	
							<!--密码存储-->
							<p>
								<label for="">
								...
								<div  class="btn btn-success button">登陆</div>
							<div class="login_z">
							<a href="" class="btn button " >立即注册</a>
							</div>
						</div>
					</div>
				</div>
